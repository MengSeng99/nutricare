      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 10),
            _buildSettingOption(context, Icons.person_add, 'Join us as our specialist', () {
              // Navigate to SpecialistRegistrationScreen
              Navigator.push(context, MaterialPageRoute(builder: (context) => const SpecialistRegistrationScreen()));
            }),
