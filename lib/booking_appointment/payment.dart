            ...
            Expanded(
              child: TextField(
                ...
                decoration: InputDecoration(
                  ...
                  suffixIcon: promoCodeController
                          .text.isNotEmpty // Only show if there's input
                      ? IconButton(
            ...
            ElevatedButton(
              onPressed: () {
                setState(() {
                  ...
                  String enteredCode =
                      promoCodeController.text.trim().toUpperCase();
                  ...
                  if (enteredCode == "1STFREE") {
                    ...
                    isPromoApplied = true;
                    selectedServiceFee =
                        originalFee * 0.5; // Apply 50% discount
                  } else {
                    isPromoApplied = false;
                    selectedServiceFee =
                        originalFee; // Reset to the original fee for other codes
                  }
                });
              },
        ...
        child: Stack(
          ...
          children: [
            Column(
              ...
              children: [
                ...
                if (!isUserInfoLoaded)
                  ...
                  _buildUserInfoRow('Date of Birth',
            ...
            if (isProfileComplete)
              Positioned(
                right:
                    0, // Adjust this value to position it correctly on the right
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildSummaryRow('Appointment Mode',
              widget.appointmentMode), // New row for appointment mode
        ],
      ),
    );
  }
                ...
                child: DropdownButtonFormField<String>(
                  ...
                  onChanged: (value) {
                    setState(() {
                      ...
                      selectedServiceFee = availableServices
                          .firstWhere(
                              (service) => service['name'] == value)['fee']
                          .toDouble();
                    });
                  },
                  decoration: InputDecoration(
...
// Function to show the add card form
  ...
  Widget _buildAddCardButton() {
    return SizedBox(
      ...
      child: ElevatedButton(
        ...
        child:
            const Text("Add New Card", style: TextStyle(color: Colors.white)),
      ),
    );
  }
  ...
  Widget _buildTotalDueSection() {
    ...
    final double originalFee = availableServices.isNotEmpty &&
